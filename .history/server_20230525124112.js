...
server.get("/api/user_table/:id", (req, res) => {
    ...
    var sql = "SELECT * FROM user_table WHERE id=" + iduser_table;
    db.query(sql, function (error, result) {
      if (error) {
        console.log("Error Connecting to DB");
      } else {
...
server.put("/api/user_table/update/:id", (req, res) => {
    let sql =
  ...
  server.delete("/api/user_table/delete/:id", (req, res) => {
    let sql = "DELETE FROM user WHERE id=" + req.params.iduser_table + "";
